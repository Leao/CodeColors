...
public class CcAppCompatCallbackManager extends CcCallbackManager {
    @Override
    protected DefStyleAdaptersHandler onCreateDefStyleAdaptersHandler() {
        return new AppCompatDefStyleAdaptersHandler();
    }

    protected static class AppCompatDefStyleAdaptersHandler extends DefStyleAdaptersHandler {
